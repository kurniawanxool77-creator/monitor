...
const detailSSKMock = {
  opd: "Sekretariat DPRD Provinsi Jawa Tengah",
  program: "Program Penunjang Urusan Pemerintahan Daerah",
  bidang: "Bagian Umum",
  subKegiatan: "Fasilitasi Kunjungan Tamu",
  paguApbd: 6141465000,
  paguVerifikasi: 6141465000,
  totalRab: 6141465000,
  uraianSsk: "Laporan fasilitasi kunjungan tamu",
  indikator: "Jumlah Laporan fasilitasi kunjungan tamu",
  jenis: "Belanja Operasi",
  sumberAnggaran: "APBD Provinsi",
  jenisIku: "Non IKU",
  bobot: 100,
  statusSesuai: true,
  statusSelesai: false,
  bulanan: [
    { target: 8.33, realisasi: 8 },
    { target: 8.33, realisasi: 8 },
    { target: 8.33, realisasi: 8 },
    { target: 8.33, realisasi: 5 },
    { target: 8.33, realisasi: 0 },
    { target: 8.33, realisasi: 0 },
    { target: 8.33, realisasi: 0 },
    { target: 8.33, realisasi: 0 },
    { target: 8.33, realisasi: 0 },
...
export function DetailSSKView() {
  const [data, setData] = useState(detailSSKMock);
