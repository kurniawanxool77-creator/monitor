              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="text" disabled={!isEditing} value={formData.nama}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="text" disabled={!isEditing} value={formData.nip}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="text" disabled={!isEditing} value={formData.jabatan}
