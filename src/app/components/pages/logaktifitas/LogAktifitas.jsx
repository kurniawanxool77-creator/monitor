      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        {filteredLogs.length === 0 ? (
          <div className="p-12 text-center text-gray-400">
            ...
            <div className="text-lg font-medium text-gray-900 mb-1">Belum ada aktivitas</div>
            <div className="text-sm">Log aktivitas yang sesuai dengan filter tidak ditemukan.</div>
          </div>
        ) : (
